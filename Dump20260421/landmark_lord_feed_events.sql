...
CREATE TABLE `feed_events` (
  ...
  `landmark_id` varchar(64) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `fk_feed_landmark` (`landmark_id`),
  KEY `idx_feed_events_time` (`created_at` DESC),
  KEY `idx_feed_events_user_time` (`user_id`,`created_at` DESC),
  CONSTRAINT `fk_feed_landmark` FOREIGN KEY (`landmark_id`) REFERENCES `landmarks` (`id`),
