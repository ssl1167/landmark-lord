...
--
-- Table structure for table `bottle_likes`
--

DROP TABLE IF EXISTS `bottle_likes`;
...
--
-- Dumping data for table `bottle_likes`
--

LOCK TABLES `bottle_likes` WRITE;
/*!40000 ALTER TABLE `bottle_likes` DISABLE KEYS */;
/*!40000 ALTER TABLE `bottle_likes` ENABLE KEYS */;
UNLOCK TABLES;
