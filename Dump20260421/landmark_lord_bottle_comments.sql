...
--
-- Table structure for table `bottle_comments`
--

DROP TABLE IF EXISTS `bottle_comments`;
...
--
-- Dumping data for table `bottle_comments`
--

LOCK TABLES `bottle_comments` WRITE;
/*!40000 ALTER TABLE `bottle_comments` DISABLE KEYS */;
/*!40000 ALTER TABLE `bottle_comments` ENABLE KEYS */;
UNLOCK TABLES;
